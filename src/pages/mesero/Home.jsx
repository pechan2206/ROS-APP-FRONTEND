...
import TipoTags from "../../components/TipoTags"; // IMPORT CORRECTO
...
const guardarPedido = async (pedidoActualizado) => {
  try {
    if (pedidoActualizado.idPedido) {
      // Actualiza en la API
      await pedidoService.actualizar(pedidoActualizado.idPedido, pedidoActualizado);
    } else {
      // Si es nuevo, crearlo
      await pedidoService.crear(pedidoActualizado);
    }
